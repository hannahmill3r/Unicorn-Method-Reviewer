    ...
    if result['submit_pressed']:
        ...
        with open(outputFile, 'r') as file:
            ...
            if result['uploaded_file'] is not None:
                ...
                highlightsIndiv = check_indiv_blocks_settings_pdf(blockData["indiv_block_data"], result['inlet_data'], result['column_params'], result['compensation_factor'], result['skid_size'], blockData["skid_size_dict"])
                highlightsPurge = check_purge_block_settings(blockData["purge_data"], result['inlet_data'], result['skid_size'], blockData['pump_a_inlet'], blockData['pump_b_inlet'], blockData["skid_size_dict"], result["scouting_blocks_included"])
